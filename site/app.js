...
const DICT = {
  fr: {
    nPrev: "Aperçu", nDet: "Détections", nInt: "Intégrité", nPipe: "Pipeline", nDl: "Télécharger", nDoc: "Docs",
    ...
    i3t: "Clipping",
    i3p: "Compte les salves d'échantillons à pleine échelle et rapporte le niveau crête en dBFS — le signe d'un master trop fort, indépendamment du caractère lossless.",
    ...
    i5t: "Export CSV",
    i5p: "Exportez tous les résultats en un clic : un fichier CSV détaillant chaque piste, prêt pour un tableur ou un script.",
    i6t: "Hi-Res & DSD",
    i6p: "Les vraies pistes haute résolution et les fichiers DSD (<code>.dsf</code> / <code>.dff</code>) reçoivent un badge vérifié — et FlacCompagnon distingue le DSD authentique d'un PCM converti après coup.",
    ...
    dlBtn: "Télécharger",
    ffnote: "ffmpeg n'est requis que pour les spectrogrammes — l'analyse s'en passe entièrement.",
  ...
  en: {
    nPrev: "Preview", nDet: "Detections", nInt: "Integrity", nPipe: "Pipeline", nDl: "Download", nDoc: "Docs",
    kick: "Open source · Rust + Tauri · macOS · Windows · Linux",
    ...
    i3t: "Clipping",
    i3p: "Counts full-scale sample runs and reports the peak level in dBFS — the sign of an over-loud master, independent of losslessness.",
    ...
    i5t: "CSV export",
    i5p: "Export every result in one click: a CSV detailing each track, ready for a spreadsheet or a script.",
    i6t: "Hi-Res & DSD",
    i6p: "Genuine high-resolution tracks and DSD files (<code>.dsf</code> / <code>.dff</code>) earn a verified badge — and FlacCompagnon tells real DSD from PCM converted after the fact.",
    ...
    dlBtn: "Download",
    ffnote: "ffmpeg is only needed for spectrograms — the analysis works entirely without it.",
