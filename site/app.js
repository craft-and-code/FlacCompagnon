...
const DICT = {
  fr: {
    ...
    s7p: "Un clic exporte l'ensemble des résultats en CSV — une ligne par piste, toutes les colonnes de l'analyse — prêt pour un tableur ou un script. Le nom et l'emplacement proposés reprennent le dossier analysé.",
    s7n1: "Astuce : la corbeille en bout de ligne écarte un fichier de la liste — il ne figurera pas dans le CSV exporté.",
    refT: "Références",
  ...
  en: {
    ...
    s7p: "One click exports every result as a CSV — one row per track, every analysis column — ready for a spreadsheet or a script. The suggested name and location follow the analyzed folder.",
    s7n1: "Tip: the trash icon at the end of a row removes a file from the list — it will not appear in the exported CSV.",
    refT: "References",
    ref1: "J. Lacroix, Y. Prime, A. Remy & O. Derrien — “Lossless Audio Checker: A Software for the Detection of Upscaling, Upsampling, and Transcoding in Lossless Musical Tracks”, AES 139th Convention, Paper 9416, New York, 2015.",
    ref2: "O. Derrien et al. — “Detection of Genuine Lossless Audio Files: Application to the MPEG-AAC Codec”, Journal of the AES, 2019.",
