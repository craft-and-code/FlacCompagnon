...
const DICT = {
  fr: {
    ...
    t1t: "Édition par lot",
    t1p: "Sélectionnez tout un album : chaque champ affiche la valeur commune ou un badge « plusieurs valeurs ». Seuls les champs que vous modifiez sont écrits — corriger l'album de 12 pistes n'écrase jamais leurs titres respectifs.",
    t2t: "Pochettes",
  ...
  en: {
    ...
    t1t: "Batch editing",
    t1p: "Select a whole album: each field shows either the shared value or a “multiple values” badge. Only the fields you actually touch are written — fixing the album on 12 tracks never flattens their individual titles.",
    t2t: "Cover art",
